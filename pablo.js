...
export default async function launch(tokenToSnipe, snipeWallet){
    ...
    console.log("Wallet:", snipeWallet)
    const snipeObject = {
    ...
    return await factory.scheduleFactory.snipeFairLaunch(snipeObjectTest)
}
